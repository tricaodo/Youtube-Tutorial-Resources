              ...
              <div className="card-content">
                {
                  ...
                  <div className="content">
                    <p><span className="has-text-weight-bold">Label:</span> {this.state.prediction.label}</p>
                    <p><span className="has-text-weight-bold">Confidence:</span> {this.state.prediction.confidence}</p>
                  </div>
                }
              </div>
            </div>
